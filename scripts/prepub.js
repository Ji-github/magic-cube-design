...
const limeVars = require('./lime-vars');
const greenLightVars = require('./greenLight-vars');
const margaretVars = require('./margaret-vars');
const moonParkVars = require('./moonPark-vars');
const scorpioVars = require('./scorpio-vars');
const clogsVars = require('./clogs-vars');
...
function finalizeDist() {
  if (fs.existsSync(path.join(__dirname, '../dist'))) {
    ...
    buildThemeFile('lime', limeVars);
    buildThemeFile('greenLight', greenLightVars);
    buildThemeFile('margaret', margaretVars);
    buildThemeFile('moonPark', moonParkVars);
    buildThemeFile('scorpio', scorpioVars);
    buildThemeFile('clogs', clogsVars);
